...
<section id="center" class="center_o">
 <div class="container">
  <div class="row center_o1 text-center">
   <div class="col-md-12">
     <h1 class="text-white">About Kenya Airways</h1>
   </div>
  </div>
 </div>
</section>
...
<section id="prosp">
 <div class="container">
   <div class="prosp_1 text-center row">
    <div class="col-md-12">
	 <h4>OUR GROUP BRANDS IN BRIEF</h4>
	 <h1><span class="col_1">We Listen,</span> <span>You Prosper</span></h1>
	 <p>This is the leading continental privately managed group of companies in aviation spreading in East Africa region and growing beyond. Its main business are in passenger transportation, cargo transportation, holidays management, Ground handling, aeronautical maintenance and aviation training.</p>
	</div>
   </div>
   <div class="prosp_2 row">
    <div class="col-md-4">
	 <div class="prosp_2i clearfix">
	  <a href="#"><img src="images/products.png"  class="w-100" alt="abc"></a>
	  <h5 class="mt-3">Plan, then do</h5>
	  <h2>Top Stories</h2>
	  <p>Emirates and Kenya Airways enter interline partnership to offer more travel options between Africa and the Middle East.</p>
	  </div>
	</div>
	<div class="col-md-4">
	 <div class="prosp_2i clearfix">
	  <a href="#"><img src="images/services.png"  class="w-100" alt="abc"></a>
	  <h5 class="mt-3">Small tactics</h5>
	  <h2>Our Agenda</h2>
	  <p>Kenya Airways Set Sights On Business Recovery By 2024 During The 47th Annual General Meeting.</p>
	  </div>
	</div>
	<div class="col-md-4">
	 <div class="prosp_2i clearfix">
	  <a href="#"><img src="images/results.jpg"  class="w-100" alt="abc"></a>
	  <h5 class="mt-3">Proof, not promises</h5>
	  <h2>KQ Projects</h2>
	  <p>Kenya Airways continues with its efforts to turn around to profitability through an aggressive growth plan while maintaining its costs.</p>
	 </div>
	</div>
   </div>
 </div>
